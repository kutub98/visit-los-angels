...
const AddBanner = () => {
  ...
  return (
    <div className="bg-yellow-800 w-full max-w-6xl mx-auto p-5">
      <div className="flex justify-between bg-white shadow-xl p-5 rounded">
        <Button>Total Banner</Button>
        ...
        <Dialog open={open} size="xl" handler={handleOpen}>
          <DialogBody className="overflow-y-scroll max-h-[90vh]">
