    ...
    <div>
      <Carousel>
        <div className="grid grid-cols-12">
          <div className="lg:col-span-5 col-span-12 lg:order-first order-last flex flex-col justify-center bg-gradient-to-b from-[#ff7676] via-[#ab67aa] to-[#1cacb1] w-full lg:px-10 p-12">
            ...
            <div className="text-left">
              ...
              <h1 className="lg:text-2xl text-lg lg:mt-6 mt-4 text-white flex">{formattedDate}</h1>
            </div>
          </div>
        ...
        <div className="grid grid-cols-12">
          ...
          <div className="lg:col-span-7 col-span-12">
            <img src={image2} alt="Guide to Los Angeles Park" className="w-full" />
          </div>
        </div>
        <div className="grid grid-cols-12">
          <div className="lg:col-span-5 col-span-12 lg:order-first order-last flex flex-col justify-center bg-gradient-to-b from-[#ff7676] via-[#ab67aa] to-[#1cacb1] w-full lg:px-10 p-12">
          ...
          <div className="lg:col-span-7 col-span-12">
            <img src={image3} alt="Guide to Los Angeles Park" className="w-full" />
          </div>
        </div>
      </Carousel>
      ...
      <div className="w-full mx-auto bg-gray-300 lg:p-10 md:p-7 p-4">
        <div className="grid grid-cols-12 gap-1 w-full max-w-2xl  justify-center mx-auto items-center ">
          ...
          <div className="lg:col-span-11 md:col-span-11 col-span-12  ">
            <select name="" id="" className="w-full bg-gray-50 px-2 py-4 rounded">
          ...
          <div className="lg:col-span-1 md:col-span-1 col-span-12 mx-auto justify-center bg-yellow-500 ">
            <button className=" bg-deep-purple-500 text-white uppercase p-5">Go</button>
          </div>
        </div>
      </div>
      {/* text  */}
      <div className="w-full mx-auto bg-gray-50 lg:p-10 md:p-7 p-4">
        <div className=" w-full max-w-2xl  justify-center mx-auto items-center ">
          <h1 className=" tracking-wide text-justify">
            ...
            , from state-of-the-art rides to walks through historic neighborhoods. Theme parks
            feature incredible thrills, while famous cultural attractions include the Getty Center,
            LACMA and Walt Disney Hall. Take flight with the Space Shuttle Endeavour, or time travel
            via Dinosaur Hall. Tour LA’s world famous studios, explore LA by bus with Starline Tours
            and the infamous TMZ Tour, or get some exercise with Bikes and Hikes. There are plenty
            of things to do and see throughout the city of LA, whether you are a solo visitor or
            here with a group. Discover all the best tourist attractions in Los Angeles, California!
          </h1>
        </div>
      </div>
      ...
      <div className=" ITINERARY lg:px-20 lg:py-8">
        <div className="w-full  mx-auto">
          <h1 className="lg:text-4xl font-semibold lg:my-10 my-6 text-2xl text-white">
            FIND YOUR PERFECT ITINERARY
          </h1>
          <div>
            <FindItinerary />
