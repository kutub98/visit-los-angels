    ...
    <div className="mainContainerBox">
      <div className="grid col-span-12 grid-cols-12 gap-1 containerBOX">
        ...
        <div className="lg:col-span-3 col-span-12 w-full flex mx-auto lg:justify-center justify-between items-center lg:h-[500px] py-auto my-2 lg:my-0 iconContainer text-left flex-col px-8">
          <h1 className="text-2xl font-semibold aboutTown w-full my-6">
            About Town
          </h1>
          <h1 className="text-justify">
            Los Angeles is home to renowned museums, unique hotels, diverse
            experiences and 75 miles of sunny coastline. The best way to
            discover LA is by exploring all of the vibrant multicultural
            neighborhoods.
          </h1>
        </div>
        {/* Slide */}
        {slides
          .slice(currentSlideIndex, currentSlideIndex + slidesPerPage)
          .map(slide => (
            <div
              key={slide.id}
              ...
              onMouseEnter={() => {
                const mainContainer =
                  document.querySelector('.mainContainerBox');
                if (mainContainer) {
